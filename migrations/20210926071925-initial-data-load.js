...
module.exports = {
  up: async (queryInterface) => {
    await queryInterface.bulkInsert('netflix', [
    ...
    await queryInterface.bulkInsert('hulu', [
    ...
    await queryInterface.bulkInsert('starz', [
  ...
  down: async (queryInterface) => {
    await queryInterface.bulkDelete('netflix')
    await queryInterface.bulkDelete('hulu')
    
    return queryInterface.bulkDelete('starz')
  }
};
